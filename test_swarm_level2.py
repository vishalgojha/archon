...
def run_mumbai_re_swarm():
    ...
    analyst_id, analyst_dna = genealogy.spawn_agent(
        "Broker pain analyst", parent_id=researcher_id, inherited_patterns=["trend_analysis"]
    )
    ...
    critic_id, critic_dna = genealogy.spawn_agent(
        "Red team critic", parent_id=synth_id, inherited_patterns=["quality_assurance"]
    )
...
"""
    ...
    return {"stream_id": stream_id, "summary": summary, "outreach": outreach.strip()}
